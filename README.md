...
It had started as a learning project, but I wanted it to be genuinely usable, not just a demo that looks good bit gets lost in the folders and I never run again.
